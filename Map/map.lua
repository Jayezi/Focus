...
hooksecurefunc("MiniMapIndicatorFrame_UpdatePosition", function()
	...
	MinimapCluster.IndicatorFrame:SetPoint("TOPRIGHT", -5, -5)
end)
...
MinimapCluster.IndicatorFrame.MailFrame:SetSize(25, 25)
MiniMapMailIcon:SetAllPoints()

MinimapCluster.IndicatorFrame.CraftingOrderFrame:SetSize(25, 25)
MiniMapCraftingOrderIcon:SetAllPoints()
